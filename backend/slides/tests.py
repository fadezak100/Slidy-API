...
class SlidesTests(APITestCase):
    ...
    def test_delete_others_slide(self):
        file = SimpleUploadedFile("test.md", b"file_content")
    ...
    def test_delete_not_existed_slide(self):
        file = SimpleUploadedFile("test.md", b"file_content")
    ...
    def test_not_existed_retrieve_slide(self):
        self.client.credentials(HTTP_AUTHORIZATION=self.token)
    ...
    def test_list_and_unauthenticated(self):
        response = self.client.get(reverse('slides-list'))
        result = response.json()
    ...
    def test_update_others_slides(self):
        file = SimpleUploadedFile("test.md", b"file_content")
    ...
    def test_update_not_existed_slide(self):
        self.client.credentials(HTTP_AUTHORIZATION=self.token)
